...
export const projectData = [
    ...
    },
    {
        ...
        title: "Gather Upp",
        description: {
            he: "מרכז מיני-משחקים שנועד לספק חווית משחק לא מקוונת חלקה ואינטראקטיבית.",
            en: "A mini-game hub designed to deliver a seamless and interactive offline gaming experience."
        },
        about: {
